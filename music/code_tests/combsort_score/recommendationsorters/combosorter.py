...
class ComboSorter:
	...
	def _normalized_with_cardinality(self,query_dict):
		...
		return self.get_field_cardinality(query_dict) * self.normalized_frequency(query_dict)	#Not a big difference. This will be faster
	...
	def _cardinality_score(self,query_dict):
		...
		return self.get_field_cardinality(query_dict) * self.ftree.get_frequency_from_dict(query_dict)	#This works horrible because artists has such a high cardinality
	...
	----------------------------------------------
	'''
	def get_field_cardinality(self, query_dict):
		return self.field_combo_cardinality(query_dict)
		#return self.max_cardinality(query_dict)

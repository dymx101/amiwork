class LocalConfig:
	...
	socialscoreupdater_life_factor = 43200					# 12 hours => For a 30 minute update interval, You achieve ~0.12% initial score after 24 hours decay	#THIS IS STRONGLY TIED TO THE UPDATE INTERVAL. BE CAREFUL :|
